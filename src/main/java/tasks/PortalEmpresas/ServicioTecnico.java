...
public class ServicioTecnico implements Task {
    ...
    public ServicioTecnico(Map<String, String> data) {
        this.data = data;
    }

    public static Performable servicioTecnico(Map<String, String> data) {
        return Instrumented.instanceOf(ServicioTecnico.class)
                .withProperties(data);
    }
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                WaitForResponse.withTarget(HEADER_LINEA_MOVIL)
