...
public class SolucionesFijasPSE implements Task {
    ...
    private static final Logger log = LoggerFactory.getLogger(SolucionesFijasPSE.class);
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        CapturasPantallasWeb.capturaPantalla("Soluciones fijas", "Soluciones fijas");
