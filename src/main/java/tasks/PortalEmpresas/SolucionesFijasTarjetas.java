    ...
    public class SolucionesFijasTarjetas implements Task {
        ...
        private static final String paso4 = "Validacion ventana confirmacion Tarjeta soluciones fijas";
        ...
        @Override
        @Step("Validar pago de soluciones fijas con tarjeta")
        public <T extends Actor> void performAs(T actor) {
            ...
            boolean paginaPresente = contenidoPagina.contains("Tarjeta")
                    || contenidoPagina.contains("Número de Factura")
                    || contenidoPagina.contains("Numero de Factura");

            if (paginaPresente) {
                log.info("Ventana de confirmacion Tarjeta soluciones fijas validada correctamente");
